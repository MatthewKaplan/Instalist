		...
		return (
			<React.Fragment>
				<View style={categoryContainer}>
					...
					<TouchableOpacity
						style={chosenCategory === 'home' ? homeActive : categoryStyles}
						onPress={() => this.setState({ chosenCategory: 'home' })}>
					...
					<TouchableOpacity
						style={chosenCategory === 'fashion' ? fashActive : categoryStyles}
						onPress={() => this.setState({ chosenCategory: 'fashion' })}>
					...
					<TouchableOpacity
						style={chosenCategory === 'cars' ? carsActive : categoryStyles}
						onPress={() => this.setState({ chosenCategory: 'cars' })}>
				...
				<View style={categoryContainer}>
					<TouchableOpacity
						style={chosenCategory === 'parts' ? partsActive : categoryStyles}
						onPress={() => this.setState({ chosenCategory: 'parts' })}>
					...
					<TouchableOpacity
						style={chosenCategory === 'sports' ? sportsActive : categoryStyles}
						onPress={() => this.setState({ chosenCategory: 'sports' })}>
					...
					<TouchableOpacity
						style={chosenCategory === 'baby' ? babyActive : categoryStyles}
						onPress={() => this.setState({ chosenCategory: 'baby' })}>
					...
					<TouchableOpacity
						style={chosenCategory === 'movies' ? headPhonesActive : categoryStyles}
						onPress={() => this.setState({ chosenCategory: 'movies' })}>
